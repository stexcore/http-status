...
*/
export function movedPermanently(location: string, message?: string) {
...
*/
export function found(location: string, message?: string) {
...
*/
export function seeOther(location: string, message?: string) {
...
*/
export function notModified(message?: string) {
...
*/
export function useProxy(proxy: string, message?: string) {
...
*/
export function temporaryRedirect(location: string, message?: string) {
...
*/
export function permanentRedirect(location: string, message?: string) {
