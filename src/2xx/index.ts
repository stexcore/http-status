...
/**
 * Success Collection with status 2xx
 */
export default {
    /**
     ...
     */
    accepted(message?: string, data?: unknown) {
     ...
     */
    nonAuthoritativeInfo(message?: string, data?: unknown) {
     ...
     */
    partialContent(message?: string, data?: unknown) {
     ...
     */
    multiStatus(message?: string, data?: unknown) {
     ...
     */
    alreadyReported(message?: string, data?: unknown) {
     ...
     */
    imUsed(message?: string, data?: unknown) {
