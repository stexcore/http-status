...
*/
export function notImplemented(message?: string, data?: unknown) {
...
*/
export function badGateway(message?: string, data?: unknown) {
...
*/
export function serviceUnavailable(message?: string, data?: unknown) {
...
*/
export function gatewayTimeout(message?: string, data?: unknown) {
...
*/
export function httpVersionNotSupported(message?: string, data?: unknown) {
...
*/
export function variantAlsoNegotiates(message?: string, data?: unknown) {
...
*/
export function insufficientStorage(message?: string, data?: unknown) {
...
*/
export function loopDetected(message?: string, data?: unknown) {
...
*/
export function bandwidthLimitExceeded(message?: string, data?: unknown) {
...
*/
export function notExtended(message?: string, data?: unknown) {
...
*/
export function networkAuthenticationRequired(message?: string, data?: unknown) {
