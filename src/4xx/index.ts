...
*/
export function methodNotAllowed(message?: string, data?: unknown) {
...
*/
export function notAcceptable(message?: string, data?: unknown) {
...
*/
export function proxyAuthRequired(message?: string, data?: unknown) {
...
*/
export function requestTimeout(message?: string, data?: unknown) {
...
*/
export function gone(message?: string, data?: unknown) {
...
*/
export function lengthRequired(message?: string, data?: unknown) {
...
*/
export function preconditionFailed(message?: string, data?: unknown) {
